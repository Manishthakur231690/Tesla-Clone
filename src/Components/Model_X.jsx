...
const Model_S = () => {
  ...
  return (
    <div>
        <Header/>
        <div id='Single_car_con' style={{backgroundImage: 'linear-gradient(to top, black 5%, transparent 50%), url("Images/Model-X-Main.avif")'}}>
                    <div className='item_text'>
                                <h1 data-aos="fade-up" data-aos-duration="1000">Modal X</h1>
                                <h3 data-aos="fade-up" data-aos-duration="1400">Plaid</h3>
                              
                                <div className="features">
                                  <div>
                                        <h2 data-aos="fade-up" data-aos-duration="1000">333 mi</h2>
                                        <p data-aos="fade-up" data-aos-duration="1000">Range</p>
                                  </div>
                                  <div>
                                        <h2 data-aos="fade-up" data-aos-duration="800">2.5 s</h2>
                                        <p data-aos="fade-up" data-aos-duration="800">0-60 mph</p>
                                  </div>
                                  <div>
                                        <h2 data-aos="fade-up" data-aos-duration="700">1,020 hp</h2>
                                        <p data-aos="fade-up" data-aos-duration="700">Peak Speed</p>
                                  </div>
                                </div>
        ...
        <div style={{background:'black', padding:'50px 0', width:'100vw'}}>
          <div id="display_flex">
            <img src="Images/connected.jpg" data-aos="fade-in" data-aos-duration="1000" />
          ...
          <div id="display_flex2">
            ...
            <img src="Images/audio.jpg" data-aos="fade-in" data-aos-duration="1000"/>
          </div>
