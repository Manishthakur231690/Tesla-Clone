...
const Model_S = () => {
  ...
  return (
    <div>
        <Header/>
        <div id='Single_car_con' style={{backgroundImage: 'linear-gradient(to top, black 5%, transparent 50%), url("Images/Model-Y-Main.avif")'}}>
                    <div className='item_text'>
                                <h1 data-aos="fade-up" data-aos-duration="1000">Modal Y</h1>
        ...
        <div style={{backgroundImage:'linear-gradient(to top, black 5%, transparent 50%, black), url(Images/Model-Y-interior.avif)',backgroundPosition:'center' , width:'100vw', height:'100vh', backgroundSize:'cover', backgroundRepeat:'no-repeat'}}>
